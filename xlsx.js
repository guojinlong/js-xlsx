...
function write_string_type(out, opts) {
	switch(opts.type) {
		...
		// case "file": return _fs.writeFileSync(opts.file, out, null);
		case "file": return _fs.writeFileSync(opts.file, iconv.encode(out, 'gbk'), null);
		case "buffer": {
...
var make_csv = iconv.encode(sheet_to_csv, 'gbk');
